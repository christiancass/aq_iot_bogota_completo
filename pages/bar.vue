  ...
  export default {
    ...
    data() {
      return {
        ...
        blueBarChart: { // Configuración inicial del gráfico
    ...
    methods: {
      ...
      convertToCSV() {
        ...
        const labels = this.blueBarChart.chartData.labels;
        const data = this.blueBarChart.chartData.datasets[0].data;
    ...
    mounted() {
      ...
      setInterval(() => {
        ...
        this.blueBarChart.chartData.labels.push(time);
        this.blueBarChart.chartData.datasets[0].data.push(randomData);
  
        // Ajustar el eje y al valor máximo de los datos generados
        const maxYValue = Math.max(...this.blueBarChart.chartData.datasets[0].data);
        this.blueBarChart.extraOptions.scales.yAxes[0].ticks.max = maxYValue;
  
        // Actualizar el gráfico
        this.$refs.bigChart.renderChart(this.blueBarChart.chartData, this.blueBarChart.extraOptions);
